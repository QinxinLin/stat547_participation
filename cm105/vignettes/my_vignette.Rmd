---
title: "Using the `pp` package"
author: "QinxinLin"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using the `pp` package}
...
Want to compute powers without having to use `^` or `**`? Give `sqrt` some friends by loading the `pp` package! 
